...
var carrouselFkty = document.querySelector('.carouselFkty');
var arrows = document.querySelector('.projects__arrows');

var flkty = new Flickity( carrouselFkty, {
...
var previousButton = arrows.querySelector('.arrows__item--prev');
var nextButton = arrows.querySelector('.arrows__item--next');
...
function showGrid() {
  body.classList.toggle("showGrid");
...
function Carousel(carousel) {
  ...
  function carouselSwitch(carousel, index, previous, auto) {
    ...
    let newSlide            = eq.call(slides, index), // renvoie l'élément par le biais de son index
